...
%% define paths:
calibration_specs = load('L:\CalCOFI\CalCOFI_Sonobuoy\Acoustic_density_estimation\Sonobuoy_calibration\Sonobuoy_calibration_specs.mat');
detections_dir = 'L:\WhaleMoanDetector_predictions\analysis\predictions_context_filtered\new_context_filter\CalCOFI_2018_06_raw_detections_context_filtered.txt';
wav_dir = 'J:\2018-06\Recordings\Sonobuoys\Difar';
...
% Initialize new column for calibrated SPL
detections.dB_SPL_calibrated = nan(height(detections), 1);
